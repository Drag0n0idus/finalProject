<?php
// source: C:\xampp\htdocs\achievements\app/config/config.neon 
// source: C:\xampp\htdocs\achievements\app/config/config.local.neon 

class Container_745531d82f extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Presenters\AchievementsPresenter' => [1 => ['application.1']],
			'App\Presenters\Error4xxPresenter' => [1 => ['application.2']],
			'App\Presenters\ErrorPresenter' => [1 => ['application.3']],
			'App\Presenters\GarmesPresenter' => [1 => ['application.4']],
		...
		'services' => [
			...
			'application.1' => 'App\Presenters\AchievementsPresenter',
			'application.2' => 'App\Presenters\Error4xxPresenter',
			'application.3' => 'App\Presenters\ErrorPresenter',
			'application.4' => 'App\Presenters\GarmesPresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp\htdocs\achievements\app',
			'wwwDir' => 'C:\xampp\htdocs\achievements\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\xampp\htdocs\achievements\app/../temp',
		];
	}
	...
	public function createServiceApplication__1(): App\Presenters\AchievementsPresenter
	{
		$service = new App\Presenters\AchievementsPresenter;
	...
	public function createServiceApplication__4(): App\Presenters\GarmesPresenter
	{
		$service = new App\Presenters\GarmesPresenter;
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\achievements\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\achievements\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\achievements\app/../temp/cache',
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_745531d82f $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\achievements\app/../temp/cache/latte');
